...
#Save request 
with open('/mnt/data/shared/planet/results_planet_torres_strait.txt', 'w') as file:
    for item in imgs:
        file.write('%s\n' % item)
    file.close()
...
metadata_df_polygons.to_csv("/mnt/data/shared/planet/planet_torres_strait_metadata.csv", index=False)
